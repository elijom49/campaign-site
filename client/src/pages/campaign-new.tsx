...
import flyerImage from "@assets/Logo Flyer.png"; // The Senator's Cup flyer
...
export default function CampaignPage() {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      {/* Petition Signing / Fundraising Event */}
      <div className="bg-blue-800 py-16 px-4 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-yellow-400 mb-8">🇺🇸 Petition Signing & Fundraising Event</h2>
