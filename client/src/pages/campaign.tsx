      ...
      <div className="content-grid-advanced py-12">
        ...
        <div className="col-span-12">
          ...
          <div className="bg-white border-4 border-yellow-400 rounded-3xl p-12">
            <div className="text-center mb-12">
              <h2 className="text-5xl font-bold text-yellow-500 mb-4">Fundraiser: The Senator's Cup</h2>
              <p className="text-xl text-gray-800 max-w-4xl mx-auto mb-8">
                Join us for The Senator's Cup — an exciting event supporting our campaign and community!
              </p>
            </div>
